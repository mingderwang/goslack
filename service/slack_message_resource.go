...
type Slack_messageResource struct {
	db gorm.DB
}

// @Title CreateSlack_message
...
func (tr *Slack_messageResource) CreateSlack_message(c *gin.Context) {
	var _log4analytics_ Slack_message

	if c.Bind(&_log4analytics_) != nil {
		c.JSON(http.StatusBadRequest, gin.H{"message": "problem decoding body"})
		return
	}
	_log4analytics_.Status = Slack_messageStatus
...
func (tr *Slack_messageResource) GetAllSlack_messages(c *gin.Context) {
	var _log4analytics_s []Slack_message
...
func (tr *Slack_messageResource) GetSlack_message(c *gin.Context) {
	id, err := tr.getId(c)
	if err != nil {
...
func (tr *Slack_messageResource) UpdateSlack_message(c *gin.Context) {
	id, err := tr.getId(c)
	if err != nil {
		c.JSON(http.StatusBadRequest, gin.H{"message": "problem decoding id sent"})
		return
...
func (tr *Slack_messageResource) PatchSlack_message(c *gin.Context) {
	id, err := tr.getId(c)
	if err != nil {
		c.JSON(http.StatusBadRequest, gin.H{"message": "problem decoding id sent"})
		return
...
func (tr *Slack_messageResource) DeleteSlack_message(c *gin.Context) {
	id, err := tr.getId(c)
	if err != nil {
		c.JSON(http.StatusBadRequest, gin.H{"message": "problem decoding id sent"})
		return
...
func (tr *Slack_messageResource) getId(c *gin.Context) (int32, error) {
